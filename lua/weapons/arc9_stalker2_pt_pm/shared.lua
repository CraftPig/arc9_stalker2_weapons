...
-- Spread ---------------------------------------------------------------------------------------------
SWEP.Spread 					= 0.0300 * (GetConVar("arc9_stalker2_mult_spread"):GetFloat())

SWEP.SpreadAddRecoil 			= 0.00189 -- Applied per unit of recoil.
...
SWEP.ShootSoundIndoor 			= { "Stalker2.5K.GlockTailIndoor" }  
SWEP.DistantShootSound 			= { "Stalker2.5K.GlockTailOutdoor" }  
