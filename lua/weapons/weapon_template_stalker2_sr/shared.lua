...
SWEP.VisualRecoilUpAddSighted 				= -0.5
SWEP.VisualRecoilSide 						= 0.2
SWEP.VisualRecoilSideAddSighted 			= -0.2
...
SWEP.RecoilKick 							= 7 -- Camera recoil
SWEP.RecoilKickDamping 						= 20.0 -- Camera recoil damping
SWEP.RecoilKickAffectPitch = nil

-- Weapon Handling ------------------------------------------------------------------------------------
SWEP.Sway 						= 0 -- How much the gun sways
SWEP.SwayAddSighted 			= 0.65
SWEP.SwayAddMidAir 				= 1
