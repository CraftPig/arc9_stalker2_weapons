...
SWEP.ImpactForce		 = 1 
SWEP.ArmorPiercing		 = 0.54
SWEP.Penetration		 = 300/1000/0.0254

SWEP.PhysBulletMuzzleVelocity 	= 614 / 0.0254
...
SWEP.GunDamagePerShot 	= 1.76 * (GetConVar("arc9_stalker2_mult_heat"):GetFloat())
...
-- Spread ---------------------------------------------------------------------------------------------
SWEP.Spread 					= 0.0111 * (GetConVar("arc9_stalker2_mult_spread"):GetFloat())
...
SWEP.ShootSoundUBGL             = { "Stalker2.GLLaunch" } 
SWEP.ShootSoundSilenced       	= { "Stalker2.GrozaFireSil" } 
...
SWEP.Animations = {
	...
	["reload_ubgl"] = {
		...
		EventTable = {
			{s = "Stalker2.M320Intro", t = 1 / 30},
			{s = "Stalker2.M320Shell", t = 52 / 30},
			{s = "Stalker2.M320Pin", t = 78 / 30},
			{s = "Stalker2.M320Outro", t = 90 / 30},
        },
    },
    ["exit_ubgl"] = {
	...
	["ready"] = {
		...
		EventTable = {
			...
			{s = "Stalker2.ArRattleMedium", t = 40 / 30},
