...
SWEP.PhysBulletMuzzleVelocity = 722 / 0.0254 -- Physical bullet muzzle velocity in Hammer Units/second. 1 HU != 1 inch.
...
SWEP.Recoil 								= 1.7 * (GetConVar("arc9_stalker2_mult_recoil"):GetFloat())
...
SWEP.RecoilMax 								= SWEP.ClipSize / 3 -- MaxRadiusExtensionModifier
